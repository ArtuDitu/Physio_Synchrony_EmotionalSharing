%%--------------------   ECG DATA ANALYSIS  ----------------------
%-----------------------------------------------------------------
% 08/02/2019 : Verdi�re. K. : Creation
%-----------------------------------------------------------------
...
% and non-asymptotic study. Application to neurosciences. PhD thesis, Universit� Nice Sophia
% Antipolis.
% 
% Authors: Kevin Verdi�re ISAE-SUPAERO Toulouse France
%
% Description:
...
Delta       = 50; % Time in millisecond in which R peak are considerend coincident.
